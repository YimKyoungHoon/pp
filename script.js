...
forEach메서드는 배열의 각요소에 대해 주어진 함수를 실행하는데
...
각 요소를 순회하며 주어진 콜백함수의 적용하고, 함수의 반환값을
새배열로 만들어 추가합니다
하지만 원본 배열은 변경되지 않습니다

결론
단순 반복문을 사용할 경우 map과 forEach 를 구분하지 않습니다
하지만 배열이고, 배열매서드를 정교하게 사용하거나,
...
//반복하고자하는 배열이름.forEach(function(el,index){적용할함수})
// numbers.forEach(function(el,index){})
